...
public class Joint {
    ...
    private Matrix4f matrixObject = new Matrix4f();
    ...
    protected void calcInverseBindTransform(Matrix4f parentBindTransform) {
        Matrix4f bindTransform = matrixObject.mul(parentBindTransform, localBindTransform);
        inverseBindTransform = matrixObject.invert(bindTransform);
